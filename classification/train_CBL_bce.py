...
if __name__ == "__main__":
    ...
    if args.dataset == 'SetFit/sst2':
        ...
        encoded_train_dataset = train_dataset.map(
            lambda e: tokenizer(
                e[CFG.example_name[args.dataset]],
                padding="max_length",
                truncation=True,
        ...
        encoded_train_dataset = train_dataset.map(
            lambda e: tokenizer(e[CFG.example_name[args.dataset]], padding="max_length", truncation=True, max_length=args.max_length), batched=True,
            batch_size=args.batch_size)
    ...
    checkpoint_interval = 100  # Save every 10,000 batches
